...
g_meetings <- ggplot(data=NULL) + stat_function(fun=function(x) 1-ecdf_f(x), n = 1000) + scale_y_log10()+scale_x_log10(limits = c(1, 5e3)) + xlab(TeX("$t$")) + ylab(TeX("P(\\tau>t)"))
print(g_meetings)

x <- seq(from = 50, to = 150, by = 1)
y <- 1-ecdf_f(x)
