...
<!-- ```{r bm, message=FALSE, warning=FALSE} -->
<!-- ##  load results from long runs of MCMC -->
<!-- proposed_cost <- table %>% filter(natoms == 10) %>% pull(totalcost) -->
<!-- proposed_variance <- table %>% filter(natoms == 10) %>% pull(variance) -->
...
<!-- ```{r spectral, message=FALSE, warning=FALSE} -->
